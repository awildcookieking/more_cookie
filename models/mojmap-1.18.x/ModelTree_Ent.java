...
public class ModelTree_Ent<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "tree_ent"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition bb_main = partdefinition.addOrReplaceChild("bb_main",
				CubeListBuilder.create().texOffs(122, 68)
						.addBox(-28.0F, -9.0F, -8.0F, 16.0F, 9.0F, 16.0F, new CubeDeformation(0.0F)).texOffs(110, 121)
						.addBox(12.0F, -9.0F, -8.0F, 16.0F, 9.0F, 16.0F, new CubeDeformation(0.0F)).texOffs(130, 28)
						...
						.addBox(-25.0F, -102.0F, -14.0F, 47.0F, 27.0F, 32.0F, new CubeDeformation(0.0F))
						.texOffs(566, 17).addBox(-7.0F, -90.0F, -3.0F, 26.0F, 12.0F, 32.0F, new CubeDeformation(0.0F))
						.texOffs(566, 17).addBox(-29.0F, -99.0F, -7.0F, 17.0F, 12.0F, 28.0F, new CubeDeformation(0.0F))
						.texOffs(566, 17).addBox(-1.0F, -108.0F, -20.0F, 17.0F, 12.0F, 28.0F, new CubeDeformation(0.0F))
						.texOffs(566, 17).addBox(10.0F, -95.0F, -12.0F, 17.0F, 12.0F, 21.0F, new CubeDeformation(0.0F)),
				PartPose.offset(0.0F, 24.0F, 0.0F));

		PartDefinition cube_r1 = bb_main.addOrReplaceChild("cube_r1",
				CubeListBuilder.create().texOffs(0, 98)
						.addBox(56.0F, 11.0F, -5.0F, 2.0F, 11.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(0, 98)
						...
						.addBox(50.0F, 11.0F, 4.0F, 2.0F, 11.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(0, 98)
						.addBox(48.0F, -12.0F, -5.0F, 9.0F, 28.0F, 10.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.0F, 0.0F, -0.6109F));

		PartDefinition cube_r2 = bb_main
				.addOrReplaceChild("cube_r2",
						CubeListBuilder.create().texOffs(0, 98).addBox(49.0F, -28.0F, -5.0F, 9.0F, 35.0F, 10.0F,
								new CubeDeformation(0.0F)),
						PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.0F, 0.0F, -0.9163F));

		PartDefinition cube_r3 = bb_main.addOrReplaceChild("cube_r3",
				CubeListBuilder.create().texOffs(0, 98)
						.addBox(-53.0F, 11.0F, 4.0F, 2.0F, 11.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(0, 98)
						...
						.addBox(-59.0F, 11.0F, 3.0F, 2.0F, 11.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(0, 98)
						.addBox(-58.0F, -12.0F, -5.0F, 9.0F, 28.0F, 10.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.0F, 0.0F, 0.6109F));

		PartDefinition cube_r4 = bb_main
				.addOrReplaceChild("cube_r4",
						CubeListBuilder.create().texOffs(0, 98).addBox(-59.0F, -35.0F, -5.0F, 9.0F, 42.0F, 10.0F,
								new CubeDeformation(0.0F)),
						PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.0F, 0.0F, 0.9163F));
