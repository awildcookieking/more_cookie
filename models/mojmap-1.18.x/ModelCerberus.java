...
public class ModelCerberus<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "cerberus"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition bb_main = partdefinition.addOrReplaceChild("bb_main",
				CubeListBuilder.create().texOffs(0, 141)
						.addBox(-33.0F, -44.0F, -24.0F, 14.0F, 44.0F, 14.0F, new CubeDeformation(0.0F)).texOffs(112, 83)
						.addBox(-33.0F, -44.0F, 11.0F, 14.0F, 44.0F, 14.0F, new CubeDeformation(0.0F)).texOffs(56, 83)
		...
		PartDefinition cube_r1 = bb_main.addOrReplaceChild("cube_r1",
				CubeListBuilder.create().texOffs(402, 309)
						.addBox(28.0F, -64.0F, -85.0F, 1.0F, 5.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(402, 309)
						.addBox(28.0F, -64.0F, -80.0F, 1.0F, 5.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(402, 309)
		...
		PartDefinition cube_r2 = bb_main.addOrReplaceChild("cube_r2",
				CubeListBuilder.create().texOffs(332, 194).addBox(-38.0F, -63.0F, -86.0F, 16.0F, 4.0F, 8.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 2.7494F, 0.3204F, 2.5732F));

		PartDefinition cube_r3 = bb_main.addOrReplaceChild("cube_r3",
				CubeListBuilder.create().texOffs(332, 194).addBox(2.0F, -67.0F, -86.0F, 35.0F, 6.0F, 8.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 2.9221F, 0.4542F, 3.0228F));

		PartDefinition cube_r4 = bb_main.addOrReplaceChild("cube_r4",
				CubeListBuilder.create().texOffs(332, 194).addBox(-1.0F, -52.0F, -103.0F, 35.0F, 6.0F, 8.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r5 = bb_main.addOrReplaceChild("cube_r5",
				CubeListBuilder.create().texOffs(332, 194).addBox(-91.0F, -54.0F, -59.0F, 35.0F, 6.0F, 8.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.0F, 0.7854F, 0.1745F));

		PartDefinition cube_r6 = bb_main
				.addOrReplaceChild("cube_r6",
						CubeListBuilder.create().texOffs(332, 194).addBox(-79.0F, -57.0F, -2.0F, 61.0F, 6.0F, 8.0F,
								new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r7 = bb_main.addOrReplaceChild("cube_r7",
				CubeListBuilder.create().texOffs(0, 0)
						.addBox(52.0F, -86.0F, -43.0F, 31.0F, 12.0F, 20.0F, new CubeDeformation(0.0F)).texOffs(0, 0)
		...
		PartDefinition cube_r8 = bb_main.addOrReplaceChild("cube_r8",
				CubeListBuilder.create().texOffs(0, 0)
						.addBox(53.0F, -86.0F, 21.0F, 31.0F, 12.0F, 20.0F, new CubeDeformation(0.0F)).texOffs(0, 0)
		...
		PartDefinition cube_r9 = bb_main.addOrReplaceChild("cube_r9",
				CubeListBuilder.create().texOffs(0, 0).addBox(40.0F, -38.0F, -13.0F, 61.0F, 12.0F, 15.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.0F, -0.4363F, -0.7418F));

		PartDefinition cube_r10 = bb_main.addOrReplaceChild("cube_r10",
				CubeListBuilder.create().texOffs(0, 0).addBox(40.0F, -38.0F, 0.0F, 61.0F, 12.0F, 15.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.0F, 0.4363F, -0.7418F));

		PartDefinition cube_r11 = bb_main
				.addOrReplaceChild("cube_r11",
						CubeListBuilder.create().texOffs(0, 0).addBox(35.0F, -38.0F, -9.0F, 61.0F, 12.0F, 15.0F,
								new CubeDeformation(0.0F)),
