...
public class ModelPoseidon<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "poseidon"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition bb_main = partdefinition.addOrReplaceChild("bb_main", CubeListBuilder.create().texOffs(791, 552)
				.addBox(-7.0F, -98.0F, -16.0F, 13.0F, 13.0F, 14.0F, new CubeDeformation(0.0F)),
				PartPose.offset(0.0F, 24.0F, 0.0F));

		PartDefinition cube_r1 = bb_main.addOrReplaceChild("cube_r1",
				CubeListBuilder.create().texOffs(340, 648).addBox(-43.0F, -23.0F, 61.0F, 6.0F, 35.0F, 5.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 1.957F, 0.8126F, 0.1873F));

		PartDefinition cube_r2 = bb_main.addOrReplaceChild("cube_r2",
				CubeListBuilder.create().texOffs(17, 429)
						.addBox(-6.0F, -44.0F, 59.0F, 6.0F, 35.0F, 5.0F, new CubeDeformation(0.0F)).texOffs(730, 861)
		...
		PartDefinition cube_r3 = bb_main.addOrReplaceChild("cube_r3",
				CubeListBuilder.create().texOffs(231, 115).addBox(-44.0F, 2.0F, 61.0F, 6.0F, 35.0F, 5.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, -1.869F, 0.9386F, 2.8985F));

		PartDefinition cube_r4 = bb_main.addOrReplaceChild("cube_r4",
				CubeListBuilder.create().texOffs(163, 311)
						.addBox(-3.0F, 6.0F, 61.0F, 6.0F, 35.0F, 5.0F, new CubeDeformation(0.0F)).texOffs(924, 297)
		...
		PartDefinition cube_r5 = bb_main.addOrReplaceChild("cube_r5",
				CubeListBuilder.create().texOffs(379, 690).addBox(-43.0F, -31.0F, 77.0F, 6.0F, 35.0F, 5.0F,
						new CubeDeformation(0.0F)),
