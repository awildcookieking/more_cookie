...
public class Modelzeus<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "zeus"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition bb_main = partdefinition.addOrReplaceChild("bb_main", CubeListBuilder.create().texOffs(724, 14)
				.addBox(-19.0F, -78.0F, -21.0F, 45.0F, 41.0F, 46.0F, new CubeDeformation(0.0F)).texOffs(0, 0)
		...
		PartDefinition cube_r1 = bb_main.addOrReplaceChild("cube_r1",
				CubeListBuilder.create().texOffs(881, 432)
						.addBox(-96.0F, -109.0F, 0.0F, 7.0F, 64.0F, 9.0F, new CubeDeformation(0.0F)).texOffs(881, 432)
						.addBox(-79.0F, -60.0F, 0.0F, 7.0F, 64.0F, 9.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r4 = bb_main.addOrReplaceChild(
				"cube_r4", CubeListBuilder.create().texOffs(800, 247).addBox(-104.0F, -16.0F, -3.0F, 11.0F, 20.0F,
		...
		PartDefinition cube_r6 = bb_main.addOrReplaceChild(
				"cube_r6", CubeListBuilder.create().texOffs(800, 247).addBox(-45.0F, -137.0F, -7.0F, 28.0F, 47.0F,
