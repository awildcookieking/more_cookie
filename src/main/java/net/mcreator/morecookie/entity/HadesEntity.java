...
package net.mcreator.morecookie.entity;
...
public class HadesEntity extends PathfinderMob {
	...
	public HadesEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(MoreCookieModEntities.HADES.get(), world);
	}

	public HadesEntity(EntityType<HadesEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
	...
	protected void dropCustomDeathLoot(DamageSource source, int looting, boolean recentlyHitIn) {
		...
		this.spawnAtLocation(new ItemStack(MoreCookieModItems.SOUL_ORB.get()));
	}
	...
	public void playStepSound(BlockPos pos, BlockState blockIn) {
		this.playSound(ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("item.trident.thunder")), 0.15f, 1);
	}
	...
	public boolean hurt(DamageSource source, float amount) {
		HadesattackcProcedure.execute(this.level, this.getX(), this.getY(), this.getZ(), source.getEntity());
