...
import net.mcreator.morecookie.procedures.StatueEntityIsHurtProcedure;
import net.mcreator.morecookie.init.MoreCookieModItems;
import net.mcreator.morecookie.init.MoreCookieModEntities;

public class StatueEntity extends PathfinderMob {
	...
	public StatueEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(MoreCookieModEntities.STATUE.get(), world);
	}
	...
	protected void dropCustomDeathLoot(DamageSource source, int looting, boolean recentlyHitIn) {
		...
		this.spawnAtLocation(new ItemStack(MoreCookieModItems.LIGHTNINGORB.get()));
	}
	...
	public boolean hurt(DamageSource source, float amount) {
		StatueEntityIsHurtProcedure.execute(this.level, this.getX(), this.getY(), this.getZ(), source.getEntity());
