...
public class SugerBlock extends SugarCaneBlock {
	public SugerBlock() {
	...
	public static void registerRenderLayer() {
		ItemBlockRenderTypes.setRenderLayer(MoreCookieModBlocks.SUGER.get(), renderType -> renderType == RenderType.cutout());
	}
}
