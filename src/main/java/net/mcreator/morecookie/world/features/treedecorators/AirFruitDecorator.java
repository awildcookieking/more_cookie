package net.mcreator.morecookie.world.features.treedecorators;
...
public class AirFruitDecorator extends CocoaDecorator {
	public static final AirFruitDecorator INSTANCE = new AirFruitDecorator();
	public static com.mojang.serialization.Codec<AirFruitDecorator> codec;
	public static TreeDecoratorType<?> tdt;
	static {
		codec = com.mojang.serialization.Codec.unit(() -> INSTANCE);
		tdt = new TreeDecoratorType<>(codec);
		tdt.setRegistryName("air_tree_fruit_decorator");
		ForgeRegistries.TREE_DECORATOR_TYPES.register(tdt);
	}

	public AirFruitDecorator() {
		super(0.2f);
	}
