...
public class AirTrunkDecorator extends TrunkVineDecorator {
	public static final AirTrunkDecorator INSTANCE = new AirTrunkDecorator();
	public static com.mojang.serialization.Codec<AirTrunkDecorator> codec;
	public static TreeDecoratorType<?> tdt;
	static {
		codec = com.mojang.serialization.Codec.unit(() -> INSTANCE);
		tdt = new TreeDecoratorType<>(codec);
		tdt.setRegistryName("air_tree_trunk_decorator");
