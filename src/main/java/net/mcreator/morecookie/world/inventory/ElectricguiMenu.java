...
public class ElectricguiMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public ElectricguiMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(MoreCookieModMenus.ELECTRICGUI, id);
