...
public class NineslotguiMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public NineslotguiMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(MoreCookieModMenus.NINESLOTGUI, id);
