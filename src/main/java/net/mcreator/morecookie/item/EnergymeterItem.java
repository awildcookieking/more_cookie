...
import net.mcreator.morecookie.procedures.EnergymetercodeProcedure;
...
public class EnergymeterItem extends Item {
	...
	public InteractionResult useOn(UseOnContext context) {
		...
		EnergymetercodeProcedure.execute(context.getLevel(), context.getClickedPos().getX(), context.getClickedPos().getY(),
