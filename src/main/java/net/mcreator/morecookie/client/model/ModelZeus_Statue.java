...
public class ModelZeus_Statue<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("more_cookie", "model_zeus_statue"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition bone = partdefinition.addOrReplaceChild("bone",
				CubeListBuilder.create().texOffs(724, 14).addBox(-28.0F, -46.0F, -26.0F, 56.0F, 28.0F, 55.0F, new CubeDeformation(0.0F))
						.texOffs(800, 247).addBox(-7.0F, -164.0F, -10.0F, 22.0F, 21.0F, 27.0F, new CubeDeformation(0.0F)).texOffs(724, 14)
		...
		PartDefinition cube_r5 = bone.addOrReplaceChild("cube_r5",
				CubeListBuilder.create().texOffs(881, 432).addBox(-79.0F, -60.0F, 0.0F, 7.0F, 64.0F, 9.0F, new CubeDeformation(0.0F))
						.texOffs(881, 432).addBox(-96.0F, -109.0F, 0.0F, 7.0F, 64.0F, 9.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.0F, 0.0F, 0.4363F));
