...
public class ManasteelOreBlock extends Block {
	public ManasteelOreBlock() {
	...
	public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
		...
		return Collections.singletonList(new ItemStack(BossrushModItems.MANASTEEL_INGOT.get()));
	}
}
