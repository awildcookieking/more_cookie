...
import net.mcreator.bossrush.procedures.RubystaffEntitySwingsItemProcedure;
import net.mcreator.bossrush.item.inventory.RubystaffInventoryCapability;
...
public class RubystaffItem extends Item {
		...
		if (entity instanceof ServerPlayer serverPlayer) {
			NetworkHooks.openGui(serverPlayer, new MenuProvider() {
				...
				public Component getDisplayName() {
					return new TextComponent("Ruby staff");
				}
	...
	public boolean onEntitySwing(ItemStack itemstack, LivingEntity entity) {
		...
		RubystaffEntitySwingsItemProcedure.execute(entity.level, entity.getX(), entity.getY(), entity.getZ(), entity, itemstack);
		return retval;
	}

	@Override
	public ICapabilityProvider initCapabilities(ItemStack stack, @Nullable CompoundTag compound) {
		return new RubystaffInventoryCapability();
	}
