...
import net.mcreator.bossrush.procedures.XpscProcedure;
import net.mcreator.bossrush.item.inventory.XpstaffInventoryCapability;

import javax.annotation.Nullable;

import io.netty.buffer.Unpooled;

public class XpstaffItem extends Item {
	public XpstaffItem() {
		...
		if (entity instanceof ServerPlayer serverPlayer) {
			NetworkHooks.openGui(serverPlayer, new MenuProvider() {
				...
				public Component getDisplayName() {
					return new TextComponent("xp staff");
				}
	...
	public boolean onEntitySwing(ItemStack itemstack, LivingEntity entity) {
		...
		XpscProcedure.execute(entity, itemstack);
		return retval;
	}

	@Override
	public ICapabilityProvider initCapabilities(ItemStack stack, @Nullable CompoundTag compound) {
		return new XpstaffInventoryCapability();
	}
