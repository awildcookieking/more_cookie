...
import net.mcreator.bossrush.procedures.JscProcedure;
import net.mcreator.bossrush.item.inventory.JadestaffInventoryCapability;
...
public class JadestaffItem extends Item {
		...
		if (entity instanceof ServerPlayer serverPlayer) {
			NetworkHooks.openGui(serverPlayer, new MenuProvider() {
				...
				public Component getDisplayName() {
					return new TextComponent("Jade staff");
				}
	...
	public boolean onEntitySwing(ItemStack itemstack, LivingEntity entity) {
		...
		JscProcedure.execute(entity, itemstack);
		return retval;
	}

	@Override
	public ICapabilityProvider initCapabilities(ItemStack stack, @Nullable CompoundTag compound) {
		return new JadestaffInventoryCapability();
	}
