...
public class RscProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z, Entity entity, ItemStack itemstack) {
		...
		if (BossrushModItems.MANACRYSTAL.get() == (new Object() {
			...
			if (!world
					.getEntitiesOfClass(Mob.class, AABB.ofSize(new Vec3(x, y, z), (10 + power * 10), (10 + power * 10), (10 + power * 10)), e -> true)
					.isEmpty()) {
				if (world instanceof ServerLevel _level)
					_level.getServer().getCommands()
							.performCommand(new CommandSourceStack(CommandSource.NULL,
									new Vec3((((Entity) world.getEntitiesOfClass(Mob.class,
											AABB.ofSize(new Vec3(x, y, z), (10 + power * 10), (10 + power * 10), (10 + power * 10)), e -> true)
											.stream().sorted(new Object() {
												Comparator<Entity> compareDistOf(double _x, double _y, double _z) {
													return Comparator.comparingDouble(_entcnd -> _entcnd.distanceToSqr(_x, _y, _z));
												}
											}.compareDistOf(x, y, z)).findFirst().orElse(null)).getX()),
											(((Entity) world.getEntitiesOfClass(Mob.class,
													AABB.ofSize(new Vec3(x, y, z), (10 + power * 10), (10 + power * 10), (10 + power * 10)),
									...
									"/summon area_effect_cloud ~ ~ ~ {Particle:\"splash\",Radius:2f,RadiusPerTick:0f,RadiusOnUse:0f,Duration:100}");
				if (((Entity) world.getEntitiesOfClass(Mob.class,
						AABB.ofSize(new Vec3(x, y, z), (10 + power * 10), (10 + power * 10), (10 + power * 10)), e -> true).stream()
						.sorted(new Object() {
							Comparator<Entity> compareDistOf(double _x, double _y, double _z) {
								return Comparator.comparingDouble(_entcnd -> _entcnd.distanceToSqr(_x, _y, _z));
							}
