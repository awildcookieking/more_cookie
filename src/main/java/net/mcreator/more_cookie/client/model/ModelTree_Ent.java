package net.mcreator.bossrush.client.model;
...
public class ModelTree_Ent<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("bossrush", "model_tree_ent"), "main");
